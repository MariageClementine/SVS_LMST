...
<div id="page">
	...
	<div id="titrePage">
		<h1>Liste des adh&eacute;rents n'ayant pas d'adresse courriel mais ayant au moins un fax.</h1>
	</div>
	<div id="zonemenu">
...
//			echo "Lancement d'une requ&ecirc;te SELECT<BR>";
			...
			$requete = "SELECT * FROM adherents WHERE Courriel1='' AND Fax!='' order by Nom,Prenom";
			...
			{
				die("Probl&egrave;me sur la requ&ecirc;te d'affichage des fax " . mysql_error() . ".");
			}
		?>
